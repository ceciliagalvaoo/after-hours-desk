...
> [!NOTE]
> **One handle, followed everywhere**
>
...
4. **Real balance movement**: buy-side fills are pulled via `ConfidentialUSDC.confidentialTransferFrom`
   ...
   documented [Roadmap](../project/roadmap.md) item rather than something patched over with a `require`.
...
![The Broker: batch settled](../../static/img/broker/money.gif)

> [!CAUTION]
> **Settlement math never wraps silently**
>
...
`ViewerRegistry.registerFill`. See [Nox Integration](./nox-integration.md) for the full story.
...
feature belongs on the [Roadmap](../project/roadmap.md) rather than being half-built here.
...
> [Roadmap](../project/roadmap.md) item.
...
wallet. See [User Flows & UX](../using-it/user-flows.md) for the actual screens.
