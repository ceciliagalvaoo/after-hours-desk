...
:::info[Read this as a map, not a scorecard]
...
For this criterion, read [Problem & Solution](/docs/problem-and-solution).
...
never a substitute for on-chain state. The full walkthrough is in [User Flows & UX](/docs/using-it/user-flows).
...
For this criterion, see the address table on the [home page](/docs/intro).
...
For this criterion, the screen-by-screen version is in [User Flows & UX](/docs/using-it/user-flows).
...
For this criterion, read [Architecture](/docs/how-it-works/architecture) and
...
For this criterion, see [User Flows & UX](/docs/using-it/user-flows).
